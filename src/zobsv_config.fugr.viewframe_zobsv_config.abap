*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOBSV_CONFIG
*   generation date: 2022.07.25 at 16:57:49
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOBSV_CONFIG        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOBSV_CONFIG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOBSV_CONFIG_EXTRACT
TOTAL = ZOBSV_CONFIG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOBSV_CONFIG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOBSV_CONFIG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOBSV_CONFIG_EXTRACT
TOTAL = ZOBSV_CONFIG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOBSV_CONFIG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOBSV_CONFIG'
...
TOTAL = ZOBSV_CONFIG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOBSV_CONFIG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOBSV_CONFIG-UPD_FLAG NE SPACE.
